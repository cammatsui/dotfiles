...
" Default group
hi Cursor ctermfg=236 ctermbg=NONE cterm=NONE guifg=#2d2a2e guibg=NONE gui=NONE
hi SignColumn ctermfg=NONE ctermbg=NONE cterm=NONE guibg=NONE guifg=NONE guisp=NONE gui=NONE
hi Visual ctermfg=NONE ctermbg=0 cterm=NONE guifg=#8a8a8a guibg=#4a4a4a gui=NONE
...
hi VertSplit ctermfg=59 ctermbg=NONE cterm=NONE guifg=#696769 guibg=NONE gui=NONE
hi MatchParen ctermfg=204 ctermbg=NONE cterm=underline guifg=#ff6188 guibg=NONE gui=underline
hi StatusLine ctermfg=231 ctermbg=NONE cterm=bold guifg=#fcfcfa guibg=NONE gui=bold
hi StatusLineNC ctermfg=231 ctermbg=NONE cterm=NONE guifg=#fcfcfa guibg=NONE gui=NONE
...
hi IncSearch ctermfg=236 ctermbg=NONE cterm=NONE guifg=#2d2a2e guibg=NONE gui=NONE
hi Search ctermfg=NONE ctermbg=NONE cterm=underline guifg=NONE guibg=NONE gui=underline
hi Directory ctermfg=209 ctermbg=NONE cterm=NONE guifg=#fc9867 guibg=NONE gui=NONE
hi Folded ctermfg=189 ctermbg=NONE cterm=NONE guifg=#d7d7ff guibg=NONE gui=NONE
...
hi DiffAdd ctermfg=231 ctermbg=NONE cterm=bold guifg=#fcfcfa guibg=NONE gui=bold
hi DiffDelete ctermfg=88 ctermbg=NONE cterm=NONE guifg=#8c0809 guibg=NONE gui=NONE
hi DiffChange ctermfg=231 ctermbg=NONE cterm=NONE guifg=#fcfcfa guibg=NONE gui=NONE
hi DiffText ctermfg=231 ctermbg=NONE cterm=bold guifg=#fcfcfa guibg=NONE gui=bold
...
hi SpecialKey ctermfg=240 ctermbg=NONE cterm=NONE guifg=#5b595c guibg=NONE gui=NONE
